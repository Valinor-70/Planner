...
export default {
  ...
  theme: {
    extend: {
      ...
      colors: {
        // Primary colors that reference CSS variables
        primary: {
      ...
      boxShadow: {
        ...
        lg: 'var(--shadow-lg)',
        xl: 'var(--shadow-xl)',
        'primary-glow': '0 4px 14px 0 rgb(139 92 246 / 0.25)',
        'primary-glow-lg': '0 6px 20px 0 rgb(139 92 246 / 0.4)',
      },
      backdropBlur: {
        xs: '2px',
      },
      ...
      animation: {
        ...
        'slide-down': 'slideDown var(--duration-slow) ease-out',
